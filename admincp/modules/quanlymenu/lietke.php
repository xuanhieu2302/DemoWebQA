    ...
    <table class='lietke_menu' >
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="./modules/quanlymenu/xuly.php?iddanhmuc=<?php echo $row['id_danhmuc']?>">Xóa</a>  |  <a href="index.php?action=quanlymenu&query=sua&iddanhmuc=<?php echo $row['id_danhmuc']?>">Sửa</a> 
