...
<?php
    if(isset($_GET['trang'])){ //khi inset trang
        ...
        $begin = ($page*10)-10;   // khi số khác thì lấy số trang nhân với 2 và trừ đi 2 sản phẩn trang trước vd đang lấy là mỗi trang 2 sp
    }
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_danhmuc = '$_GET[id]' AND tinhtrang=1 ORDER BY id_sanpham DESC LIMIT $begin,10"; //lấy tất cả sản phẩm dựa vào id 
